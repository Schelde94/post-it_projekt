...
-- Schema pms
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `magnusmultimedia_dk_postit` DEFAULT CHARACTER SET latin1 ;
USE `magnusmultimedia_dk_postit` ;

-- -----------------------------------------------------
-- Table `pms`.`color`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnusmultimedia_dk_postit`.`color` (
...
-- Table `pms`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnusmultimedia_dk_postit`.`users` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- Table `pms`.`postit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `magnusmultimedia_dk_postit`.`postit` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_postit_color`
    ...
    REFERENCES `magnusmultimedia_dk_postit`.`color` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_postit_users1`
    FOREIGN KEY (`users_id`)
    REFERENCES `magnusmultimedia_dk_postit`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 2
